...
export default function HeroSection() {
  return (
    <section className="relative pt-12 pb-20 lg:pt-20 lg:pb-32 bg-gradient-to-b from-blue-50/60 via-white to-slate-50/50 overflow-hidden">
      {/* Background Decorative Blur Elements */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-blue-400/20 via-indigo-300/10 to-transparent rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            <AnimateOnScroll animation="fade-up">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-100/90 border border-blue-200 text-blue-700 text-xs font-semibold uppercase tracking-wider mb-6 shadow-xs">
                <Sparkles className="w-3.5 h-3.5 text-blue-600" /> Payment Infrastructure 3.0
              </div>
            ...
            <AnimateOnScroll animation="fade-up" delay={200}>
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <Link
                  href="/payments"
                  className="w-full sm:w-auto px-7 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-semibold text-base shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-600/40 transition-all flex items-center justify-center gap-2 cursor-pointer group"
                >
                  Mulai Sekarang
                ...
                <Link
                  href="/kontak"
                  className="w-full sm:w-auto px-7 py-3.5 rounded-xl border border-gray-300 hover:border-blue-600 bg-white hover:bg-blue-50/50 text-gray-800 font-semibold text-base transition-all flex items-center justify-center cursor-pointer"
                >
                  Hubungi Sales
                </Link>
              </div>
          ...
          <div className="lg:col-span-5">
            <AnimateOnScroll animation="scale-up" delay={150}>
              <div className="relative mx-auto max-w-md lg:max-w-none">
                ...
                <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-2xl border border-gray-200/80 hover:shadow-blue-500/10 transition-shadow">
