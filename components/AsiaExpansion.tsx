          ...
          <div className="lg:col-span-6">
            <AnimateOnScroll animation="fade-up">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-red-500/20 border border-red-400/30 text-red-300 text-xs font-semibold uppercase tracking-wider mb-6">
                <Globe className="w-3.5 h-3.5 text-red-400" /> Ekspansi Pasar Asia Tenggara
              </div>

              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight">
                Terima Pembayaran Lintas Negara Tanpa <span className="bg-gradient-to-r from-red-400 to-sky-300 bg-clip-text text-transparent">Hambatan Valas</span>
              </h2>
            </AnimateOnScroll>
