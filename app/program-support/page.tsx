...
export const metadata: Metadata = {
  ...
  description: "Solusi pembayaran, payment link, dan pembiayaan modal usaha terlengkap untuk mendukung pertumbuhan bisnis UMKM Indonesia.",
  openGraph: {
    title: "Program Support UMKM | Nusandana",
    description: "Solusi pembayaran, payment link, dan pembiayaan modal usaha terlengkap untuk mendukung pertumbuhan bisnis UMKM Indonesia.",
    type: "website",
...
export default function ProgramSupportHubPage() {
  const jsonLd = {
    ...
    serviceType: "Solusi Pembayaran & Pembiayaan UMKM",
    description: "Program bantuan dan solusi keuangan digital untuk Usaha Mikro, Kecil, dan Menengah.",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-sans text-gray-900">
      ...
      <main className="flex-grow">
        ...
        {/* Section 2 Module 3: Pembiayaan Modal Usaha UMKM */}
        <section id="pembiayaan">
